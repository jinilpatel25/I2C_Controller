; C:\USERS\ADMIN\DESKTOP\ASSIGNMENT5_NOCACHE\I2C_CONTROLLER_NO_CACHE\M68KV6.0-800BY480\PROGRAMS\DEBUGMONITORCODE\M68KDEBUG.C - Compiled by CC68K  Version 5.00 (c) 1991-2005  Peter J. Fondse
...
; void SetSPIFlashWriteEnableLatch(void){
       xdef      _SetSPIFlashWriteEnableLatch
...
; void ClearSPIFlashWriteEnableLatch(void){
       xdef      _ClearSPIFlashWriteEnableLatch
...
; //}
; void WaitForSPIFlashWriteCompletion(void){
       xdef      _WaitForSPIFlashWriteCompletion
